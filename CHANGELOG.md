...
All notable changes to this product. Format: `X.XX.XXX` (display) — see `fqlab.__version__`. Keep `0.x`
...
- Offline `data-pipeline/` (`fqlab`): the two data contracts (ingestion + artifact), the named staged
