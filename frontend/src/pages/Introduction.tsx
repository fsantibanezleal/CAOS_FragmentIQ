...
export default function Introduction() {
  ...
  return (
    <article className="page-body prose">
      ...
      <Callout variant="strong" title={es ? 'Toda la CV se ejecuta en vivo en el navegador' : 'All the CV runs live in the browser'}>
        {es
          ? 'El generador de muckpile, la delineación watershed y el ajuste PSD se ejecutan en TypeScript en el navegador; el CNN de bordes se ejecuta vía onnxruntime-web. Al seleccionar un caso, la PSD se recalcula al instante; el slider de escala (mm/px) reescala las unidades. (Este build no tiene carga de fotos.)'
