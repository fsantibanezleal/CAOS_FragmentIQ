// LIVE lane (optional, Pyodide): load the inlined fqlab sources (public/pyodide/sources.json) and call
// fqlab.live.run_trace_json for a bring-your-own-params interaction in the browser. This is a STUB — a real
