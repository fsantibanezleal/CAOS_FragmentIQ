"""pipeline, FragmentIQ's offline+light engine (ADR-0057). Muckpile fragmentation: instance segmentation of rock
...
case-results.json into replay traces); `--retrain` regenerates the learned models (torch -> ONNX), see pipeline/science/.
"""
